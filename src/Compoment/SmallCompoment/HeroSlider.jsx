...
import { ontionalPageFilter } from "../API/tmdbAPI";
...
export const HeroSliderContainer = (props) => {
  ...
  const { backdrop_path, original_title, overview, poster_path, id, title } =
    item;
    ...
    <>
      ...
      >
        ...
        >
          <div
            className="poster"
            style={{ width: "25%", position: "relative", borderRadius: "15px" }}
          >
            <Link to={`/movies/${id}`}>
              <img
